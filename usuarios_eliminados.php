...
<p style="text-align: center;"><span style="font-size:24px;"><b>Usuarios eliminados:</b></span></p>
<hr2></hr2>
...
/*departamento si hay encragado
  $sql =$mysqli->query( "SELECT nombre, fk_dep
,(select nombre from departamento  where pk_d_id=fk_dep) as ndep
      FROM usuario
");*/
  $sql =$mysqli->query( "SELECT nombre,dia,hora
      FROM eliminado_b$empresa");
