...
<html>
<head>
	<title>Ceover-Permisos Co-encargado</title>
...
<nav class='navbar navbar-inverse'>
  ...
  <li><a href='Departamentos.php' >  &nbsp;Regresa a Departamentos&nbsp; &nbsp; </a></li>
...
<p style="text-align: center;"><span style="font-size:24px;"><b>&iexcl;Asigna permisos del Co-encargado</b></span><b style="font-size: 24px;">!&nbsp; &nbsp; &nbsp; &nbsp;</b></p>
<hr2></hr2>

<p>&nbsp;</p>
<form id="myform" action="permisos_coenc-p.php" enctype="multipart/form-data" method="post">  
<div style='text-align: center;'>

<?php

$dbcon2 = new mysqli('localhost', 'id4nt3', 'pipomuere666', 'Ceover') or die("No se pudo connectar");$dbcon2->set_charset('utf8');
$sql2 =$dbcon2->query( "SELECT * FROM permisos_coenc");

for ($i = 0; $f = $sql2->fetch_object(); $i++) {
    if($f->activado==1){echo "<p> $f->PC:<input type='checkbox' id='$f->pk_coenc'  name='checkbox[]'  value='$i' checked='checked'/>";}else{echo "<p>";echo " $f->PC:<input type='checkbox' id='$f->pk_coenc'  name='checkbox[]'  value='$i'/>";}
...
<p style="text-align: center;"><span style="text-align: center;"><input name="submit" id="submit" type="submit" value="Asignar permisos" /></span></p>
</form></div>
<p>&nbsp;</p>
