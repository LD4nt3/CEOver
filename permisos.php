...
<p style="text-align: center;"><span style="font-size:24px;"><b>&iexcl;Asigna permisos del Co-administrador</b></span><b style="font-size: 24px;">!&nbsp; &nbsp; &nbsp; &nbsp;</b></p>
<hr2></hr2>

<p>&nbsp;</p>
<form id="myform" action="permisos-p.php" enctype="multipart/form-data" method="post">  
...
$sql2 =$dbcon2->query( "SELECT * FROM permisos_co$empresa");

for ($i = 0; $f = $sql2->fetch_object(); $i++) {
    if($f->activado==1){echo "<p> $f->PC:<input type='checkbox' id='$f->pk_perm'  name='checkbox[]'  value='$i' checked='checked'/>";}else{echo "<p>";echo " $f->PC:<input type='checkbox' id='$f->pk_perm'  name='checkbox[]'  value='$i'/>";}
