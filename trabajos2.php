...
$numbre = $sqlo->fetch_object();
$cal=$numbre->nombre." ".$numbre->apellido_p." ".$numbre->apellido_m;


	

for($i=0;$f = $sql->fetch_object();$i++){ 
    if($cal!=$f->calificado && $f->calificado!='sin calificar' ){
    $d=1;
...
////////////
 ...
 if($d==1){
	if ($f->estado=='Entregado' || $f->estado=='Tarde') {
