...
<head>
  ...
  <title>CEOver-Departamentos</title>
...
if($fa->permiso=='Administrador'){
 ...
 <li><a href='graficas_presa.html' >  &nbsp; Grafic&aacute;s&nbsp; &nbsp; </a></li>
...
if($fa->permiso=='Administrador'){echo"
<p style='text-align: center;'><span style='font-size:24px;'><b>&iexcl;Estos son los departamentos de t&uacute; empresa</b></span><b style='font-size: 24px;'>!</b><a href='Agrega_un_departamento.php'>Agrega un departamento </a></p>";}else{echo"
<p style='text-align: center;'><span style='font-size:24px;'><b>&iexcl;Estos son los departamentos de t&uacute; empresa</b></span><b style='font-size: 24px;'>!</b></p>";}
...
<div  style="overflow-y: auto; height:600px; ">
   <p><hr2></hr2></p>
<form id="myform" action="Departamento_individual.php" enctype="multipart/form-data" method="post">  
...
<div class='grid-item'>
<img alt='' height='115' src='https://languages.opensuse.org/images/8/84/Icon-merge.png' width='115' >
</div>

<div class='grid-item'><b><u>
Departamento</b></u>: $f->nombre    &nbsp;<br><b><u>Encargado</b></u>: $f->nombreE  $f->apellido_p $f->apellido_m    &nbsp; 
</div>

<div class='grid-item'>
<input type='submit' name='$f->pk_d_id' id='$f->pk_d_id' value='Ver Departamento' />
