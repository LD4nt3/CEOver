...
$a=$numero[$i]+1;
$x[$i]=$a;     
$sql = "UPDATE permisos_co$empresa SET activado=1 WHERE pk_perm='$a'"; mysqli_query($dbcon,$sql); 
echo $a;
echo "<br>";
...
if($lon==0){
   while(11>$ese){
                ...
                $sql = "UPDATE permisos_co$empresa SET activado=0 WHERE pk_perm='$ese' "; mysqli_query($dbcon,$sql);
          $ese++;
        }    
...
//en el cual todos los numeros menores al numero selecionado se desactivan que indica que no se seleciono y se debe aumentar en uno al final z para saltar el valor que se tenia de resultado 
      ...
      while($x[$e]>$z ){
           echo "<br>yy ";
              ...
              echo$z;
                $sql = "UPDATE permisos_co$empresa SET activado=0 WHERE pk_perm='$z' ";
